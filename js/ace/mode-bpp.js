ace.define("ace/mode/bpp", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/c_cpp_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(e, t, n) {
    var r = e("../lib/oop"),
        i = e("./text").Mode,
    ...
    var r = e("../lib/oop"),
        ...
        u = function() {
            var e = "break|case|continue|default|do|merkulonben|leptessed|goto|mivanha|_Pragma|visszamesz|switch|csinaljad|catch|operator|try|throw|using|masik",
                t = "asm|__asm__|auto|logikai|_Bool|karakter|_Complex|tortszam|enum|float|_Imaginary|egeszszam|egesszam|nagy|short|signed|struct|typedef|union|csakpozitiv|void|class|wchar_t|template|szoveg|semmi|mutato|vesszo|kettospont|referencia|pont",
                n = "allando|extern|register|restrict|static|volatile|inline|ninja:|belsos:|politikus:|friend|explicit|virtual|export|mutable|typename|sorvege|osztaly|struktura",
                r = "es|and_eq|bitand|bitor|compl|nyet|not_eq|vagy|or_eq|typeid|xor|xor_eqconst_cast|dynamic_cast|reinterpret_cast|static_cast|sizeof|namespace|egyezik|nemegyezik|legyen|kevesebb|nagyobb|legalabb|maximum|plusz|minusz|szor|per|maradek|megnovel|nyit|zar|osszefuz|nevter|nyitokapocs|zarokapocs|ures_tomb|kezd|vege",
                s = "NULL|igaz|hamis",
